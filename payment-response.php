...
include("functions.<a href="#">php</a>");
...
if (!isset($_POST["txn_id"]) &amp;amp;amp;&amp;amp;amp; !isset($_POST["txn_type"])){
    ...
    // read the post from <a href="#">PayPal</a> system and add 'cmd'
    ...
    foreach ($_POST as $key =&amp;amp;gt; $value) {
        ...
        $value = preg_replace('/(.*[^%^0^D])(%0A)(.*)/i','${1}%0D%0A${3}',$value);// <a href="#">IPN</a> fix
    ...
    // post back to <a href="#">PayPal</a> system to validate
    ...
    $fp = fsockopen ('ssl://www.sandbox.<a href="#">paypal</a>.com', 443, $errno, $errstr, 30);
    ...
    if (!$fp) {
        ...
        while (!feof($fp)) {
            ...
            if (strcmp($res, "VERIFIED") == 0) {
                ...
                // mail('user@domain.com', '<a href="#">PAYPAL</a> POST - VERIFIED RESPONSE', print_r($post, true));
                ...
                if ($valid_txnid &amp;amp;amp;&amp;amp;amp; $valid_price) {
                    ...
                    if ($orderid) {
                        ...
                        // mail('user@domain.com', '<a href="#">PAYPAL</a> POST - INSERT INTO DB WENT WRONG', print_r($data, true));
                ...
                //@mail("user@domain.com", "<a href="#">PAYPAL</a> DEBUGGING", "Invalid Response
